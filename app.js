...
const blockButtons = () => {
    const optionsButtons = optionsContainer.querySelectorAll(".options");
    const letterButtons = letterContainer.querySelectorAll(".letters");
    // Disable all Buttons
...
const generateWord = (optionsValue) => {
    ...
    // Replace every letter span containing dash
